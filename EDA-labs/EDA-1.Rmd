...
sub_pop <- census %>%
  select(
    ...
    White_Male,
    White_Female,
    FreeColoredPopulation,
    FreeColored_Female,
    Slave_Male,
    FreePersons,
    FreePersons_White_Male,
    FreePersons_ColoredPersons,
    FreePersons_ColoredPersons_Female,
    SlavePopulation_Female,
    DisabledWhite_DeafandDumb,
    InsaneandIdioticPersons_AtPublicCharge,
    PersonsEmployedinMining,
    PersonsEmployedinCommerce,
    PersonsEmployedinOceanNavigation,
    PersonsEmployedEngineersProfessional,
    CollegeUniversityStudents,
    PrimaryCommonSchoolStudents,
    Male,
    WhitePopulation,
    FreeColored_Male,
    SlavePopulation,
    Slave_Female,
    FreePersons_White,
    FreePersons_White_Female,
    FreePersons_ColoredPersons_Male,
    SlavePopulation_Male,
    DisabledWhite,
    InsaneandIdioticPersons,
    InsaneandIdioticPersons_AtPrivateCharge,
    PersonsEmployedinAgriculture,
    PersonsEmployedinManufacturingTrade,
    PersonsEmployedinLandNavigation,
    PensionersofRevolutionaryWarorMilitaryService,
    AcademyGrammarSchoolStudents
  )
```
- Save the tibble that you create in the "data" subfolder using `write_csv`, with an appropriately descriptive filename.
```{r}
setwd("..")
write_csv(sub_pop, "./data/sub_pop.csv")
```
